<template>
    <div ref="filemanager-container">
        ...
        <create-folder
            ...
            :current="currentPath"
            v-on:closeCreateFolderModal="closeModalCreateFolder"
        ...
        <div class="card relative" id="filemanager-manager">
                ...
                <div class="w-full flex flex-wrap">
                    <div class="w-1/2 flex flex-wrap justify-start">
                        ...
                        <button
                            ...
                            class="btn btn-default btn-primary mr-3"
                        >{{ __('Create folder') }}</button>

                        <button
                            v-if="buttons.select_multiple"
                            type="button"
                            class="btn btn-default btn-primary text-white mr-3 flex items-center"
                            @click="multiSelecting=!multiSelecting"
                        >
                            <svg
                                class="w-6 h-6 fill-current pt-1"
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 24 24"
                            >
                        ...
                        <button
                            ...
                            type="button"
                            class="btn btn-default btn-small btn-danger text-white mr-3"
            ...
            <UploadProgress
                ref="uploader"
                :current="currentPath"
                v-on:removeFile="removeFileFromUpload"
            ></UploadProgress>
        </div>
    </div>
</template>
...
export default {
    ...
    async created() {
        /**
         * Conseguimos el usuario y lo seteamos como home
         */
        let { data: username } = await Nova.request().get(
            'nova-vendor/infinety-es/nova-filemanager/username'
        );
